...
## Power Supply (U3: ME6211C33M5G-N)

SOT-23-5, 500mA, LDO 3.3V regulator. LCSC C82942.
...
### Pin-by-pin: ME6211C33M5G-N (SOT-23-5)

| Pin | Name | Connection |
|-----|------|------------|
| 1 | VIN | 5V input rail. C1 (10uF 0603 X5R) + C2 (100nF 0402 X7R) to GND |
| 2 | VOUT | 3.3V output rail. C3 (22uF 0603 X5R) + C4 (100nF 0402 X7R) to GND |
| 3 | CE (chip enable) | Tied to VIN (always on) |
| 4 | GND | Ground |
| 5 | NC | No connect |
...
- ME6211 500mA capacity provides ample margin
